...
import { CreateOrganizationUserRoleInputModel, CreateOrganizationUserRoleOutputModel, ORGANIZATION_ROLES } from '../models/organization-user-role-model';

export class CreateOrganizationUserRoleCommandHandlerHandler implements CqrsServiceBase {
    ...
    async handle(
        ...
        try {
            // set admin role
            let organizationUserRole = new OrganizationUserRoleModel({...input, role: [ORGANIZATION_ROLES.admin]});
